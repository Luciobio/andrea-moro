        ...
        >
            <div className="flex flex-col items-center justify-center lg:flex-row md:flex-col sm:flex-col bg-grisoscuro size-8/12 lg:size-9/12 ">
                <div className="flex items-center justify-center  w-1/3 ">
                    <Image draggable='false' className="align-center w-full h-full lg:w-9/12 rounded-full" src={aboutSelfie} alt={""} />
                </div>
                ...
                <Image  draggable='false' className="h-full w-1/3 lg:flex md:hidden sm:hidden hidden" src={aboutFlower} alt={"Magnolia"} />
            </div>
        </div>
    );
};
