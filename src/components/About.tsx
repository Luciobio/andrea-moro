...
import aboutSelfie from "../../public/images/main.jpeg";
        ...
        >
            <div className="flex flex-col items-center justify-center size-4/5 xl:lg:flex-row xl:lg:size-9/12 bg-grisoscuro">
                <div className="flex items-center justify-center w-1/3">
                    <Image draggable='false' className="my-4 align-center w-full h-full xl:lg:w-9/12  overflow-hidden" src={aboutSelfie} alt={""} />
                </div>
                <div className="flex flex-col justify-center w/auto lg:w-1/3 md:w-2/3 sm:w-2/3">
                    ...
                    <p className="w-4/5 font-light mx-auto text-sm lg:md:sm:text-sm mb-8 overflow-hidden">Formadora en arte floral eterno.
                    
                    <br />Enseño a crear flores realistas con método, técnica y alma. Mi propósito es ayudarte a desarrollar habilidades artísticas y lograr piezas que reflejen la belleza de la naturaleza con un alto nivel de realismo.
                    
                    <br />A través de mis cursos, comparto los conocimientos, procesos y secretos que he perfeccionado durante años para que puedas crear con confianza y alcanzar resultados extraordinarios.
